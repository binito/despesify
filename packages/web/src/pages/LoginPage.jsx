  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-600 to-primary-900">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        ...
        <p className="text-center text-gray-500 mb-6">Gerenciar suas despesas de forma inteligente</p>
        ...
        <p className="text-center text-gray-600 mt-6">
          Não tem conta? <Link to="/register" className="text-primary-600 hover:underline">Registre-se aqui</Link>
        </p>
      </div>
    </div>
  )
